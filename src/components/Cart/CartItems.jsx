    ...
    return (
        <>
            ...
            {Array.isArray(cartData) && cartData?.length > 0 ? cartData?.map((cartItem) => (
                ...
                <div key={cartItem?._id} className="select-none mb-3 bg-gray-100 rounded-lg w-full text-blue-gray-700 max-h-full overflow-auto py-2 px-2 flex justify-center">
